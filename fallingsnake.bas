...
76 D0=0: GOSUB 1070 : REM SET SPRITE DATA OFFSET
77 GOSUB 1020
...
102 BO=29*256:SI=42:            : REM BOTTOMSCREENOFFSET, STONEIMAGE
103 PO=15*256:PI=81:PC=2:PX=20  : REM PLAYEROFFSET, PLAYERIMAGE, PLAYERCOLOR
104 DE=1000                     : REM DELAY VALUE
105 S=0 : REM SET SCORE
106 D0=4: GOSUB 1070 : REM SET SPRITE DATA OFFSET
...
212 IF PE=SI THEN GOSUB 1025: GOTO 400
...
1172 VPOKE $1,$FC13,(X0 AND $0300)/$100
1173 VPOKE $1,$FC14,Y0 : REM YPOS 128
1174 VPOKE $1,$FC15,$00
1175 RETURN
